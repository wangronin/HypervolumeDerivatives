...
x0 = pd.read_csv(path + f"DTLZ7_NSGA-III_run_{run}_lastpopu_x.csv", header=None).values[0:50]
y0 = pd.read_csv(path + f"DTLZ7_NSGA-III_run_{run}_lastpopu_y.csv", header=None).values[0:50]
